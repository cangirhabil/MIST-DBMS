...
-- İzlenen filmlerle ilgili detaylı bilgileri gösteren view
...
-- Film izleme listesine film ekleme
...
-- Kullanıcının ortalama film değerlendirmesini hesaplama
...
-- Film güncelleme timestamp fonksiyonu
...
-- Film güncellendiğinde timestamp güncelleme
